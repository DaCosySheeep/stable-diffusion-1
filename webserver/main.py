...
import sys, time, functools, os, datetime, builtins, threading, pystray, random, subprocess, torch, numpy, json, default_prompt
    ...
    if result:
        ...
        try:
            ...
            generate(prompt=result[1], negative_prompt=result[2], 
                     ...
                     ddim_steps=result[9], outdir=result[11],
